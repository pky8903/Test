...
int main(int argc, char* argv[])
{
    ...
    switch (mode) {
        case 0:
            fft_C2C(d_input, N, dx, direction, stream, d_output);
            break;
        case 1:
            fft_R2C(d_input, N, dx, direction, stream, d_output_r2c);
            break;
        default:
            fft_C2C(d_input, N, dx, direction, stream, d_output); 
            break;
    ...
    switch(mode) {
        case 0:
            test_C2C(d_output, N, x0, dx, dk, sigma, stream);
            break;
        case 1:
            test_R2C(d_output_r2c, N, x0, dx, dk, sigma, stream);
            break;
        default:
            test_C2C(d_output, N, x0, dx, dk, sigma, stream);
            break;
